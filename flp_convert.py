...
def dec_to_flp(a: float):
    ...
    print(f"\nLiczba: {a}", ) #Liczba do przekonwertowania
    ...
    print(f"\nMantysa nieznormalizowana: {man_}")
    ...
    #zaokrąglamy
    man_rounded = _round_bin(man_normalized, man_len)
    if len(man_rounded) > man_len + 1:
        ...
        print(f"Mantysa po zaokrągleniu wynosi 1.{man_rounded}, dodatkowy bit nie zmienił mantysy")
